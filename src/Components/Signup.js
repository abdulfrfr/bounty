...
function Signup(){
    ...
    return(
        <section className="bg-gray-200 h-[100vh]">
            ...
            <div className="md:w-[50vw] md:h-[80vh] flex flex-col justify-start items-center">
                ...
                <div className=''>
                    <div className='flex justify-between items-center my-2 mx-5'>
                        <div className='md:mx-5 mx-0'>
                            ...
                            <input onChange={getSignupInput} className='border-none p-4 rounded-xl md:w-[30vw] lg:w-[21vw] w-[44vw] outline-blue-500' type="text" name="firstName" placeholder="First Name" value={signup.firstName}/>
                        </div>
                        <div className='md:mx-5 mx-0'>
                            <div className='text-xl ml-1 text-gray-800'>Last Name</div>
                            <input onChange={getSignupInput} className='border-none p-4 rounded-xl md:w-[30vw] lg:w-[21vw] w-[44vw] outline-blue-500' type="text" name="lastName" placeholder="First Name" value={signup.lastName}/>
                        </div>
                    </div>
                ...
                <div>
                    <Link to="/login">
                        <button className='text-white text-lg text-gray-700 bg-blue-500 md:w-[50vw] lg:w-[30vw] w-[90vw] rounded-xl mt-3 p-4'>Sign Up</button>
                    </Link>
                </div>
            </div>

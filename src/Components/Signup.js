    ...
    <section className="bg-gray-200 lg:h-[100vh] pt-20">
      ...
      <div className="block md:flex md:justify-center md:items-start">
        ...
        <div className="'md:mx-5 md:w-[50vw] md:h-[80vh] flex flex-col justify-start items-center">
          <div className="w-[15rem] text-center text-gray-700 p-2 font-bold text-xl md:text-3xl border-b-[1px] border-gray-300">
            SIGN UP
          </div>
          <div className="">
            <div className="flex justify-between items-center my-2 ">
              <div className="">
                ...
                <input
                  ...
                  className="border-none p-4 rounded-xl md:w-[24vw] lg:w-[22vw] w-[44vw] outline-blue-500"
                  type="text"
                  name="firstName"
            ...
            <div className="my-2 ">
              ...
              <input
                onChange={getSignupInput}
                className="border-none p-4 rounded-xl md:w-[50vw] lg:w-[45vw] w-[91vw] outline-blue-500"
                type="email"
                name="email"
                placeholder="Email"
                value={signup.email}
            ...
            <div className="my-2 ">
              <div>
                ...
                <input
                  onChange={getSignupInput}
                  className=" mb-2 border-none p-4 rounded-xl md:w-[50vw] lg:w-[45vw] w-[91vw] outline-blue-500"
                  type="password"
                  name="password"
              ...
              <div>
                <div className="text-xl ml-1 text-gray-800">
                  Confirm Password
                </div>
                <input
                  onChange={getSignupInput}
          ...
          <div>
            <Link to="/login">
              <button className="text-white text-lg bg-blue-500 md:w-[50vw] lg:w-[45vw] w-[90vw] rounded-xl mt-3 p-4">
                Sign Up
              </button>
            </Link>
          </div>
          <div>
            <div className="flex justify-center items-center">
              ...
              <Link to="/login">
                <div className="flex justify-center items-end ml-1 text-blue-500">
                  Login In <BsArrowRight />
                </div>
              </Link>
            </div>
          </div>

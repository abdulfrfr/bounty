...
function Logo({navs, setPage, setStyl}){
    ...
    return(
        <section>
            <Link to="/">
                    <div onClick={getHome} className="outline-blue-500 px-5 hidden md:flex md:justify-center md:items-center text-2xl md:text-3xl text-blue-500 font-extrabold">BOUNTY</div>

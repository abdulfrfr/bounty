...
function Journal({showEdit, setShowEdit, journalItems, whenJournIsClicked, setToEmpty}){
    ...
    return(
        <section className={showEdit ? "relative md:pt-28 sm:pt-16 pt-5 md:pl-28 sm:pl-10 pl-2 md:pr-10 md:pb-10 w-[83vw] lg:w-[40vw] box-border transition-all duration-300" : "relative md:pt-28 sm:pt-16 pt-5 md:pl-28 sm:pl-10 pl-2 md:pr-10 md:pb-10 w-[83vw] box-border"}>
            <div className="">
            ...
            <div className="flex items-center justify-end md:items-end border-b-2 border-gray-700 pb-2 pt-8 pr-4">
                <div className="text-sm flex items-center justify-between w-[55vw] sm:w-[30vw] md:w-[20vw] lg:w-[15vw]">
                    ...
                    <div>
                        <button onClick={onClickNewButton} className="bg-blue-600 py-1 px-2 rounded-md flex justify-center items-center text-white"><div className='mr-1 text-white'>New</div> <FaChevronDown className='pl-1 border-l-[1px] border-black'/></button>
                    </div>
                </div>
            </div>
                        ...
                        return(
                            <div onMouseOver={() => setIsShow(true)} onMouseOut={() => setIsShow(false)} className='flex justify-between items-center py-1 px-2 rounded-md hover:bg-gray-300 box-border'>
                                <div className='flex justify-start items-center'>
                                    ...
                                    <CiEdit onClick={() => getShowEdit(journ)} className={isShow ? 'block text-xl' : 'text-xl hidden'}/>
                                </div>
